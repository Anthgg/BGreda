...
def _line_out(fila: V2QuotationProduct, warnings: list[str]) -> V2QuotationProductOut:
    return V2QuotationProductOut(
        ...
        unit_volume_cm3=fila.unit_volume_cm3,
        total_volume_cm3=fila.total_volume_cm3,
        firing_occupancy_percent=fila.firing_occupancy_percent,
        firing_volume_share_percent=fila.firing_volume_share_percent,
        firing_commercial_cost=fila.firing_commercial_cost,
        firing_gas_cost=fila.firing_gas_cost,
