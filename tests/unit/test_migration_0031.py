...
def test_0031_sigue_en_el_camino_a_la_cabeza() -> None:
    ...
    mudo a `test_migration_0032.py` cuando entro. Dejarla aqui obligaria a
    ...
    assert "0031" in {revision.revision for revision in script.iterate_revisions(heads[0], "base")}
